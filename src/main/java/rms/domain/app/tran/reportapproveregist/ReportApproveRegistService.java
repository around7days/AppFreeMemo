 ...
 */
@Service
public class ReportApproveRegistService extends rms.common.abstracts.AbstractService {

    /** logger */
    private static final Logger logger = LoggerFactory.getLogger(ReportApproveRegistService.class);
