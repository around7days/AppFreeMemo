 ...
 */
@Service
public class ReportApplyListService extends rms.common.abstracts.AbstractService {

    /** logger */
    private static final Logger logger = LoggerFactory.getLogger(ReportApplyListService.class);
    ...
    public SearchResultEntity<ReportApplyListEntityResult> search(ReportApplyListEntityCondition condition,
        ...
        // 検索結果格納
        SearchResultEntity<ReportApplyListEntityResult> resultEntity = new SearchResultEntity<>();
