...
--申請者区分：B001
INSERT INTO m_code( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'B001', '申請者区分', '1', '申請者', '', '', '', 0, 0, now(), 'system', now(), 'system');
--承認者区分：C001
INSERT INTO m_code( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'C001', '承認者区分', '1', '承認者', '', '', '', 0, 0, now(), 'system', now(), 'system');
--管理者区分：D001
INSERT INTO m_code( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'D001', '管理者区分', '1', '管理者', '', '', '', 0, 0, now(), 'system', now(), 'system');
commit;