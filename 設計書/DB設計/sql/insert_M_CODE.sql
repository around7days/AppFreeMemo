DELETE FROM M_CODE;
--承認状況：A001
INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'A001', '承認状況', 'XXX', '未提出'    , '', '', '', 0, 0, now(), 'system', now(), 'system');
