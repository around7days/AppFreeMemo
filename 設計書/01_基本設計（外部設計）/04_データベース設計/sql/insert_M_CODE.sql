...
----承認区分：C001
--INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'C001', '承認区分', 'Y', '承認', '', '', '', 0, 0, now(), 'system', now(), 'system');
--INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'C001', '承認区分', 'N', '否認'  , '', '', '', 0, 0, now(), 'system', now(), 'system');
--部署：D001
INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'D001', '部署', '1', '第一ソリューション部', '1SOL', '', '', 0, 0, now(), 'system', now(), 'system');
INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'D001', '部署', '2', '第二ソリューション部', '2SOL', '', '', 0, 0, now(), 'system', now(), 'system');
INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'D001', '部署', '3', '第一ソフトウェア開発部', '1PS', '', '', 0, 0, now(), 'system', now(), 'system');
INSERT INTO M_CODE( code_kbn, code_kbn_nm, code, code_nm, attr1, attr2, attr3, version, del_flg, ins_date, ins_id, upd_date, upd_id) VALUES ( 'D001', '部署', '4', '第二ソフトウェア開発部', '2PS', '', '', 0, 0, now(), 'system', now(), 'system');
commit;
